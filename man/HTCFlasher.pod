...
information. You can also extract the contents of the ROM upgrade
...
B<-X> Extract the contents of a NBH upgrade file
...
Extract ROM contents from a NBH upgrade file:
